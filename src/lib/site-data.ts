...
export const STORIES = [
  { slug: "tunde", name: "Tunde, age 6", quote: "He said my name for the first time after 9 months of speech therapy.", body: "When Tunde first came to Elchay, he was non-verbal and easily overwhelmed in groups. With nine months of consistent speech therapy, a sensory-friendly classroom, and a dedicated parent coach, Tunde now uses 40+ words and attends an inclusive primary school." },
  { slug: "amaka", name: "Amaka, age 9", quote: "I love school now. My teacher uses my picture cards.", body: "Amaka's school was ready to ask her to leave. Elchay's teacher-training program equipped her teachers with visual supports and sensory breaks. Today Amaka is thriving — top of her class in mathematics." },
  { slug: "the-okoye-family", name: "The Okoye Family", quote: "We finally feel seen.", body: "After years of being told their son was 'just stubborn,' the Okoyes received a full assessment and a clear plan at Elchay. The whole family — siblings included — joined our monthly support circle." },
] as const;
